...
def main(seed):
    ...
    n_states = 16 # K
    n_actions = 4 # A
    seq_len = 20 # 20 # N - this is an upper bound on the horizon. Mostly the horizon will be determined by the terminal state
    n_seq = 1000 # 10000 # M - number of sequences (trajectories) in the dataset
    df = 1
    outer_iters = 50 # 150
    n_iters_model_learning = 10 # 20
    lr_model_learning = 1e-1 # 1e-2
