...
def learn_model_using_mle(mdp_model_params, dataset, n_states, n_actions, seq_len, n_iters, lr):
    ...
    return start_scores, transition_scores, reward_scores
...
def main(seed):
    ...
    for oi in range(outer_iters):
        ...
        mdp_model_params = [start_scores, acting_policy_scores, transition_scores, reward_scores]

        # learn model of the mdp from dataset of trajectories
        print('LEARNING MODEL...')
        # *** TODO - input true policy scores (frozen) to the model learning
        start_scores, transition_scores, reward_scores = learn_model_using_mle(mdp_model_params, dataset, n_states, n_actions, seq_len, n_iters_model_learning, lr_model_learning)
    ...
    plt.savefig('plots/mbpo_alternating_feedingPolicy_windy_gridworld' + hyperparams_string + '_.png')
